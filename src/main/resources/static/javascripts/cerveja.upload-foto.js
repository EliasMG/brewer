...
Brewer.UploadFoto = (function() {
	...
	UploadFoto.prototype.iniciar = function () {
		...
		if (this.inputNomeFoto.val()) {
			rendenrizarFoto.call(this, { nome:  this.inputNomeFoto.val(), contentType: this.inputContentType.val()});
		}
	}
	
	function onUploadCompleto(resposta) {
		this.novaFoto.val('true');
		rendenrizarFoto.call(this, resposta);
	}
	
	function rendenrizarFoto(resposta) {
