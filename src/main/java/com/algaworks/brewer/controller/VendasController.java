...
public class VendasController {
	...
	public ModelAndView alterarQuantidade(@PathVariable("codigoCerveja") Cerveja cerveja, Integer novaQuantidade, String uuid) {
		tabelaItens.alterarQuantidade(uuid, cerveja, novaQuantidade);
	...
	public ModelAndView excluirItem(@PathVariable("codigoCerveja") Cerveja cerveja, @PathVariable String uuid) {
		tabelaItens.excluirItemVenda(uuid, cerveja);
		
		return mvTabelaItensVenda(uuid);
	}
	
	@GetMapping
	public ModelAndView pesquisar(VendaFilter vendaFilter, @PageableDefault(size = 5) Pageable pageable, HttpServletRequest httpServletRequest) {
	...
	public ModelAndView editar(@PathVariable Long codigo) {
		...
		for (ItemVenda item : venda.getItens()) {
			tabelaItens.adicionarIten(venda.getUuid(), item.getCerveja(), item.getQuantidade());
		}
